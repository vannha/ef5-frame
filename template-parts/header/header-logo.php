...
*/
// Default Logo
$logo             = ef5frame_get_opts( 'logo', array( 'url' => '', 'id' => '' ) );
$logo_size        = ef5frame_get_opts( 'logo_size', array( 'width' => ef5frame_configs('logo_width'), 'height' => ef5frame_configs('logo_height'), 'units' => ef5frame_configs('logo_units') ) );

$logo_size_w      = ef5frame_extract_numbers($logo_size['width']) ? ef5frame_extract_numbers($logo_size['width']) : ef5frame_configs('logo_width') ;
$logo_size_h      = ef5frame_extract_numbers($logo_size['height']) ? ef5frame_extract_numbers($logo_size['height']): ef5frame_configs('logo_height');
...
if ( !empty($logo['id']) ) {
    ...
    if($logo_mime_type !== 'image/svg+xml'){
        $logo_url        =  ef5frame_get_image_url_by_size( [
            'id'   => $logo['id'], 
            'size' => $logo_size_w.'x'.$logo_size_h
        ]);
        $logo_url_retina =  ef5frame_get_image_url_by_size( [
            'id'   => $logo['id'], 
...
$ontop_logo             = ef5frame_get_opts( 'ontop_logo', array( 'url' => '', 'id' => '' ) );
$ontop_logo_size        = ef5frame_get_opts( 'ontop_logo_maxh', array( 'width' => ef5frame_configs('logo_width'), 'height' => ef5frame_configs('logo_height'), 'units' => ef5frame_configs('logo_units') ) );
$ontop_logo_size_w      = ef5frame_extract_numbers($ontop_logo_size['width']) ?  ef5frame_extract_numbers($ontop_logo_size['width']) : ef5frame_configs('logo_width');
$ontop_logo_size_h      = ef5frame_extract_numbers($ontop_logo_size['height']) ? ef5frame_extract_numbers($ontop_logo_size['height']) : ef5frame_configs('logo_height');
...
if ( !empty($ontop_logo['id']) ) {
    ...
    if($logo_mime_type !== 'image/svg+xml'){
        $ontop_logo_url        =  ef5frame_get_image_url_by_size( [
            'id'   => $ontop_logo['id'], 
            'size' => $ontop_logo_size_w.'x'.$ontop_logo_size_h
        ]);
        $ontop_logo_url_retina = ef5frame_get_image_url_by_size( [
            'id'   => $ontop_logo['id'], 
...
$sticky_logo             = ef5frame_get_opts( 'sticky_logo', array( 'url' => '', 'id' => '' ) );

$sticky_logo_size        = ef5frame_get_opts( 'sticky_logo_maxh', array( 'width' => ef5frame_configs('logo_width'), 'height' => ef5frame_configs('logo_height'), 'units' => ef5frame_configs('logo_units') ) );
$sticky_logo_size_w      = ef5frame_extract_numbers($sticky_logo_size['width']) ? ef5frame_extract_numbers($sticky_logo_size['width']) : ef5frame_configs('logo_width');
$sticky_logo_size_h      = ef5frame_extract_numbers($sticky_logo_size['height']) ? ef5frame_extract_numbers($sticky_logo_size['height']) : ef5frame_configs('logo_height');
...
if ( !empty($sticky_logo['id'] ))
{
    ...
    if($logo_mime_type !== 'image/svg+xml'){
        $sticky_logo_url        = ef5frame_get_image_url_by_size( [
            'id'   => $sticky_logo['id'], 
            'size' => $sticky_logo_size_w.'x'.$sticky_logo_size_h
        ]);
        $sticky_logo_url_retina    = ef5frame_get_image_url_by_size( [
            'id'   => $sticky_logo['id'], 
